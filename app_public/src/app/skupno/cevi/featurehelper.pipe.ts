...
export class FeaturehelperPipe implements PipeTransform {
  ...
  transform(AirConditioning:string, bluetooth:string, Navigation:string, usb:string, aux:string, parkingsensors:string, autopilot:string, accessibility:string): string {
    var rezultat ="";
    debugger;
